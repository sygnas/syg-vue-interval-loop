'use strict';Object.defineProperty(exports,'__esModule',{value:true});var script = {
  ...
  mounted: function mounted() {
    ...
    this.intervalId = setInterval(function () {
      _this.now = (_this.now + 1) % _this.max;
    }, this.delay);
  },
...
var __vue_module_identifier__ = "data-v-ca22ae0c";
/* functional template */
...
var install = function installvueIntervalLoop(Vue) {
  if (install.installed) return;
  install.installed = true;
  Vue.component('vueIntervalLoop', __vue_component__);
